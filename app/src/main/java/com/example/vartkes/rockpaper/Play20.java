...
public class Play20 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_play20);
        ...
        b_rock.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (YourScore < 20 && ComputerScore < 20)
        ...
        b_comment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (YourScore == 20 || ComputerScore == 20) {
                    Intent Level20 = new Intent(Play20.this, Play20.class);
